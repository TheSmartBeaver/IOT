...
/**
 * Digital Input State: RW, Single, Mandatory
                         ...
                         anjay_output_ctx_t *ctx)
{
    ...
    case RID_DIGITAL_INPUT_STATE:
        ...
        return anjay_ret_bool(ctx, inst->captor_state); // TODO
                          ...
                          anjay_input_ctx_t *ctx)
{
    ...
    case RID_DIGITAL_INPUT_STATE:
        assert(riid == ANJAY_ID_INVALID);
        return anjay_get_bool(ctx, &inst->captor_state); // TODO
...
const anjay_dm_object_def_t **presence_object_create(void)
{
    ...
    // TODO: object init
    presence_instance_t *inst = add_instance(obj, 0);
    if (inst)
    {
        strcpy(inst->application_type, "Presence captor");
        inst->captor_state = false;
        printf("\n INITTTTT \n");
    }
    else
